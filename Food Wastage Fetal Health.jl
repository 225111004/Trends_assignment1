...
# ╔═╡ 66d17899-2ad8-4913-bf9c-c4c92ec6a098
using CSV, DataFrames, MLJ, Plots, MLJLinearModels, ScientificTypes, MLJBase, Tables, CategoricalArrays, StatisticalMeasures  

# ╔═╡ 7ab99bb6-bb48-45c0-84f4-21b0f65632c3
md"""
### 1. importing Packages
"""

# ╔═╡ 7cab2640-4859-4479-835b-d0e78abfac35
# Explicitly import select from DataFrames to avoid ambiguity
begin
import DataFrames: select, Not, rename!
import MLJ: machine, fit!, predict, predict_mode
end

# ╔═╡ 28d528e5-6637-4129-a8fc-89f557b1b343
md"""
### 2. Loadning and Cleaning dataset
"""

# ╔═╡ 01ab2062-b8b1-40c0-a010-6e5eea44be47
# Load datasets
begin
...
# ╔═╡ 16f07c5b-3f3a-43bc-9b38-10b83dfdf919
fetal_health_df = CSV.read("fetal_health.csv", DataFrame)

# ╔═╡ c8bbdfcc-0cbb-434f-b481-12eef9dbb4e7
# -------------------------------------------------------------------
# PROBLEM 1: REGRESSION MODEL
# -------------------------------------------------------------------

# ╔═╡ 4b2b67e0-5cc1-42ce-a0d0-8e1a5bdb06ef
# Select features using explicitly imported select function
X_fw = select(food_waste_df, Not([:Economic_Loss, :Household_Waste]))

# ╔═╡ 3cc12ede-c4f1-4f6a-911b-1a104742f8d4
...
manifest_format = "2.0"
project_hash = "476351e5cf254f6aa747fea9fbcf19867885ab98"
